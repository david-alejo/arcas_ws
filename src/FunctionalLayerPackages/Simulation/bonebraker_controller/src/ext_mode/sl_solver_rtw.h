...
LINKAGE_SPEC void rsimTerminateEngine(SimStruct* S);
...
LINKAGE_SPEC boolean_T isVariableStepSolver(const char* slvrName);

LINKAGE_SPEC boolean_T isFixedStepSolver(const char* slvrName);
