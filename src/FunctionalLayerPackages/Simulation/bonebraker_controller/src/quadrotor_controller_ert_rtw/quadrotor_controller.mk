...
#
# File    : ert_unix.tmf   $Revision: 1.55.4.54 $
#
# Abstract:
...
MAKECMD         = /usr/local/MATLAB/R2010b/bin/glnxa64/gmake
HOST            = UNIX
BUILD           = yes
SYS_TARGET_FILE = any
...
MODEL                   = quadrotor_controller
MODULES                 = quadrotor_controller_data.cpp 
MAKEFILE                = quadrotor_controller.mk
MATLAB_ROOT             = /usr/local/MATLAB/R2010b
ALT_MATLAB_ROOT         = /usr/local/MATLAB/R2010b
MASTER_ANCHOR_DIR       = 
START_DIR               = /media/JRUIZ/quadrotor_model
S_FUNCTIONS             = 
S_FUNCTIONS_LIB         = 
NUMST                   = 1
NCSTATES                = 0
...
MODELLIB                  = quadrotor_controllerlib.a
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
...
# Additional includes 
ADD_INCLUDES = \
	-I$(START_DIR)/quadrotor_controller_ert_rtw \
	-I$(START_DIR) \
