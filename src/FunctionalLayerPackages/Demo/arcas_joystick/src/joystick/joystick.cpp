...
int CJoystick::get_joystick_status(struct wwvi_js_event* wjse) {
	...
	while ((rc = read_joystick_event(&jse) == 1)) {
		...
		if (jse.type == JS_EVENT_AXIS) {
			...
			case 5:
				wjse->stick_x = (((jse.value+32767)*2048)/-65534) + 2048;
				break;
			case 6:
                wjse->stick_y = (((jse.value+32767)*2048)/-65534) + 2048;
				break;
			case 0:
				wjse->stick2_x = (((jse.value+32767)*2048)/-65534) + 2048;
				break;
			case 1:
				wjse->stick2_y = (((jse.value+32767)*2048)/-65534) + 2048;
				break;
			default:
				break;
			}
