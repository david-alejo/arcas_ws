...
MODEL                   = brazo_ros
MODULES                 = brazo_ros_data.cpp rtGetInf.cpp rtGetNaN.cpp rt_nonfinite.cpp rt_pow_snf.cpp 
MAKEFILE                = brazo_ros.mk
MATLAB_ROOT             = /usr/local/MATLAB/R2010b
ALT_MATLAB_ROOT         = /usr/local/MATLAB/R2010b
MASTER_ANCHOR_DIR       = 
START_DIR               = /media/JRUIZ/Arcas/cineInversa
S_FUNCTIONS             = 
S_FUNCTIONS_LIB         = 
NUMST                   = 1
NCSTATES                = 0
