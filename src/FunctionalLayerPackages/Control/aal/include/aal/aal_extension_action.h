 ...
 */
#define CONTRACTING_JOINT_2 -3.14159

/*!
 * \brief ANGLE CONTRACTING 3 JOINT
 */
#define CONTRACTING_JOINT_3 3.14159
 ...
 */
#define EXTENDING_JOINT_2 -0.7853

/*!
 * \brief ANGLE EXTENDING 3 JOINT
 */
#define EXTENDING_JOINT_3 1.5707
 ...
 */
#define EXTENDING_JOINT_5 -0.7853
...
public:
	...
	enum State
	{
		EXTENDED= arcas_actions_msgs::AALExtensionActionGoal::EXTENDED,
		CONTRACTED= arcas_actions_msgs::AALExtensionActionGoal::CONTRACTED,
		EXTENDEDING,
		CONTRACTING
	};
