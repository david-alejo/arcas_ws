 ...
 * Real-Time Workshop file generated on : Thu Oct 24 16:38:01 2013
 * TLC version                          : 7.6 (Jul 13 2010)
 * C/C++ source code generated on       : Thu Oct 24 16:38:02 2013
 *
...
#ifndef _DEFINED_TYPEDEF_FOR_IRBSSensor_
#define _DEFINED_TYPEDEF_FOR_IRBSSensor_

typedef struct {
  TState state;
  real_T dRelativePositionX;
  real_T dRelativePositionY;
  real_T dRelativePositionZ;
  real_T dVelocityX;
  real_T dVelocityY;
  real_T dVelocityZ;
  real_T dYawAngle;
  real_T dPositionDeviationX;
  real_T dPositionDeviationY;
  real_T dPositionDeviationZ;
  real_T dVelocityDeviationX;
  real_T dVelocityDeviationY;
  real_T dVelocityDeviationZ;
  real_T dYawDeviation;
} IRBSSensor;

#endif

#ifndef _DEFINED_TYPEDEF_FOR_ICardanBoard_
#define _DEFINED_TYPEDEF_FOR_ICardanBoard_
...
#ifndef _DEFINED_TYPEDEF_FOR_IUavStateArcas_
#define _DEFINED_TYPEDEF_FOR_IUavStateArcas_
...
#ifndef _DEFINED_TYPEDEF_FOR_IControlRefArcas_
#define _DEFINED_TYPEDEF_FOR_IControlRefArcas_
...
#ifndef _DEFINED_TYPEDEF_FOR_TPosServosArm_
#define _DEFINED_TYPEDEF_FOR_TPosServosArm_

typedef struct {
  uint16_T uiPosServo1;
  uint16_T uiPosServo2;
  uint16_T uiPosServo3;
  uint16_T uiPosServo4;
  uint16_T uiPosServo5;
  uint16_T uiPosServo6;
  uint16_T uiPosServo7;
  uint16_T uiPosServo8;
} TPosServosArm;

#endif

#ifndef _DEFINED_TYPEDEF_FOR_TVelServosArm_
#define _DEFINED_TYPEDEF_FOR_TVelServosArm_

typedef struct {
  uint16_T uiVelServo1;
  uint16_T uiVelServo2;
  uint16_T uiVelServo3;
  uint16_T uiVelServo4;
  uint16_T uiVelServo5;
  uint16_T uiVelServo6;
  uint16_T uiVelServo7;
  uint16_T uiVelServo8;
} TVelServosArm;

#endif

#ifndef _DEFINED_TYPEDEF_FOR_IJointArm_
#define _DEFINED_TYPEDEF_FOR_IJointArm_

typedef struct {
  TState state;
  TPosServosArm posServosArm;
  TVelServosArm velServosArm;
} IJointArm;

#endif

#ifndef _DEFINED_TYPEDEF_FOR_TArmPosition_
#define _DEFINED_TYPEDEF_FOR_TArmPosition_
...
#ifndef _DEFINED_TYPEDEF_FOR_TArmVelocity_
#define _DEFINED_TYPEDEF_FOR_TArmVelocity_
...
#ifndef _DEFINED_TYPEDEF_FOR_IArmControlReferences_
#define _DEFINED_TYPEDEF_FOR_IArmControlReferences_

typedef struct {
  TState state;
  uint8_T uiArmExtensionFlag;
  uint8_T uiArmRetractionFlag;
  TArmPosition armPosition;
  TArmVelocity armVelocity;
  THeartBeat heartBeat;
} IArmControlReferences;
